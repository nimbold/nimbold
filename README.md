...
I hold a Bachelor’s degree in Software Engineering, which gave me a strong foundation in system logic. As I continue to learn and grow, I enjoy building practical tools and experimenting with new technologies. I actively use AI assistants like Gemini and Codex to pair-program, write code, and accelerate my learning process.
...
- **Languages & Frameworks:** Python (Tkinter), Swift (SwiftUI), JavaScript, standard system architectures.
- **Development Philosophy:** Building modular, well-documented, clean codebase structures.
- **Current Goals:** Exploring native desktop integration, concurrency, and persistent system models.
